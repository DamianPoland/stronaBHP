        ...
        <header className={style.background}>
            <nav className={style.container}>
                ...
                <ul onClick={() => setIsOpenMobileMenu(false)} className={`${style.list} ${styleMobileMenu}`}>
                    ...
                    <li className={style.listItem}><NavLink to='/etraining' activeClassName={style.activeLink} className={style.listItemAnchor}>E-szkolenia</NavLink></li>
                    <li className={style.listItem}><NavLink to='/knowledge' activeClassName={style.activeLink} className={style.listItemAnchor}>Baza wiedzy</NavLink></li>
                    <li className={style.listItem}><NavLink to='/news' activeClassName={style.activeLink} className={style.listItemAnchor}>Nowości</NavLink></li>
